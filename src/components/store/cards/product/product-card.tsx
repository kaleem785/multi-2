...
export default function ProductCard({ product }: { product: ProductType }) {
  ...
  console.log(variantImages, "variant images");
  console.log(variants, "variants");

  return (
    <div>
      <div className='group w-[190px] min-[480px]:w-[225px] relative transition-all duration-75 bg-white ease-in-out p-4 rounded-t-3xl border border-transparent hover:shadow-xl hover:border-border'>
